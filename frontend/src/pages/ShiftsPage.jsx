...
function ExtraChargeModal({ caregivers, elders, serviceTypes, onClose, onSaved, initial }) {
  ...
  const availableServiceTypes = serviceTypes.filter((serviceType) => serviceType.active || serviceType.id === form.service_type_id);
